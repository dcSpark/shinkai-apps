export default {
  ...
  tools: {
    ...
    successExecuteTool: 'Tool executed successfully',
    errorExecuteTool: 'Tool execution failed',
    canNowEditToolInPlayground: 'You can now edit the tool in the playground',
    errorUpdateTool: 'Failed to update tool',
    oauthSetSuccess: 'OAuth settings updated successfully',
    successUpdateToolConfig: 'Tool configuration updated successfully',
    ...
    errorPublishTool: 'Failed to publish tool',
    installFromStore: 'Install from Store',
    fileSavingCancelled: 'File saving cancelled',
    successExportTool: 'Tool exported successfully',
    errorExportTool: 'Failed to export tool',
    showSimplifiedExecutionError: 'Show simplified error',
    showFullExecutionError: 'Show full error message',
