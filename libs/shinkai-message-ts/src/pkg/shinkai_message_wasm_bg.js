...
export class JobCreationWrapper {
    ...
    */
    constructor(scope_js, is_hidden, associated_ui_js) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jobcreationwrapper_new(retptr, addBorrowedObject(scope_js), is_hidden, addHeapObject(associated_ui_js));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class ShinkaiMessageBuilderWrapper {
    ...
    * @returns {string}
    */
    static job_creation(my_encryption_secret_key, my_signature_secret_key, receiver_public_key, scope, is_hidden, associated_ui, sender, sender_subidentity, receiver, receiver_subidentity) {
        let deferred9_0;
        let deferred9_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            ...
            const len6 = WASM_VECTOR_LEN;
            wasm.shinkaimessagebuilderwrapper_job_creation(retptr, ptr0, len0, ptr1, len1, ptr2, len2, addHeapObject(scope), is_hidden, addHeapObject(associated_ui), ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
