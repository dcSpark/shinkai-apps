...
export function shinkaimessagebuilderwrapper_job_message(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number): void;
...
export function jobmessagewrapper_new(a: number, b: number, c: number): void;
...
export function jobmessagewrapper_fromStrings(a: number, b: number, c: number, d: number): number;
