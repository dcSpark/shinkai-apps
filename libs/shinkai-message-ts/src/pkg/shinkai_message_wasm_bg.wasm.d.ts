...
export function jobcreationwrapper_new(a: number, b: number, c: number, d: number): void;
...
export function shinkaimessagebuilderwrapper_job_creation(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number): void;
