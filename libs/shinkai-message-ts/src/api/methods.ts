...
import { AgentCredentialsPayload, CredentialsPayload, JobCredentialsPayload, LastMessagesFromInboxCredentialsPayload, SetupPayload, ShinkaiMessage } from "../models";
...
export const submitRegistrationCode =
  async (setupData: SetupPayload): Promise<boolean> => {
    try {
      const messageStr =
