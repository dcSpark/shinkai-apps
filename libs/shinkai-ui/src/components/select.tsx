...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    className={cn(
      ...
      'focus:ring-official-gray-700 placeholder:text-official-gray-400 focus:outline-none focus:ring-1 focus:ring-inset disabled:cursor-not-allowed disabled:opacity-50',
