  ...
  ({ className, type, startAdornment, endAdornment, ...props }, ref) => {
    ...
    return (
      <>
        <input
          className={cn(
            'h-input disabled:text-gray-80 border-official-gray-750 bg-official-gray-900 focus:border-official-gray-700 peer w-full rounded-lg border px-4 py-3 pt-8 text-sm font-medium text-white placeholder-transparent outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-200 focus:border focus:outline-0 disabled:border-0 disabled:bg-gray-400',
