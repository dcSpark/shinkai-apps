  ...
  return (
    <Label
      className={cn(
        ...
        'peer-focus:text-xs peer-focus:leading-tight peer-focus:text-gray-100 peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-gray-500',
        // select
