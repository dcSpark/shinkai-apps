...
>(({ asChild = false, className, children, ...props }, ref) => {
  ...
  return (
    <div
      className={cn(
        'bg-official-gray-700 text-muted-foreground data-[state=completed]:bg-brand data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground data-[state=active]:bg-official-gray-850 relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium',
        className,
      )}
      data-state={state}
      ref={ref}
