...
const badgeVariants = cva(
  'focus:ring-ring focus:outline-hidden border-official-gray-780 inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:ring-2 focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
