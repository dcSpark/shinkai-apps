...
export const treeOptions: TreePassThroughOptions = {
  ...
  content: {
    className: cn(
      'text-official-gray-200 mb-1 rounded-lg bg-transparent p-1 py-1.5 shadow-none hover:bg-gray-400 hover:text-white',
  ...
  toggler: ({ context }: TreePassThroughMethodOptions) => ({
    className: cn(
      ...
      context.selected
        ...
        : 'hover:text-official-gray-200 text-white hover:bg-gray-400',
