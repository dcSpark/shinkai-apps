                        ...
                        <div className="relative z-50 flex items-end gap-3 self-end">
                          ...
                          <Button
                            className={cn(
                              ...
                              'disabled:text-official-gray-750 disabled:bg-official-gray-800 disabled:border-official-gray-900 hover:disabled:bg-official-gray-700 disabled:pointer-events-none disabled:cursor-not-allowed disabled:border',
                            )}
                            disabled={
