...
function CodePanelBase({
  ...
  const renderCodeElement = useCallback(() => {
    ...
    if (
      ...
      return (
        <p className="text-official-official-gray-900 pt-6 text-center text-xs">
      ...
      return (
        ...
        >
          <div className="bg-official-gray-950 border-official-gray-750 sticky top-0 z-10 flex h-[40px] shrink-0 items-center justify-between rounded-t-sm border-b px-3 py-2">
            <span className="text-official-official-gray-900 inline-flex items-center gap-2 pl-2 text-xs font-medium">
              {' '}
              {detectedLanguage}{' '}
              {isDirtyCodeEditor && (
  ...
  return (
    <div className="flex size-full min-h-[220px] flex-col">
      <div className="flex h-full flex-col">
        ...
        {/*      <div>*/}
        {/*        <CopyToClipboardIcon*/}
        {/*          className="text-official-official-gray-900 flex h-7 w-7 items-center justify-center rounded-lg border border-official-gray-900 bg-transparent transition-colors hover:bg-official-gray-700 hover:text-white [&>svg]:h-3 [&>svg]:w-3"*/}
        {/*          string={toolCode ?? ''}*/}
        {/*        />*/}
        {/*      </div>*/}
        {/*    </TooltipTrigger>*/}
