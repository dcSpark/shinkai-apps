    ...
    <Popover>
      <TooltipProvider delayDuration={0}>
        <Tooltip>
          ...
          <PopoverContent
            align="end"
            className="min-w-[400px] bg-gray-300 px-6 py-7 text-xs"
            side="top"
          >
            ...
            <Form {...form}>
              <form
                className="flex w-full flex-col justify-between space-y-6 overflow-hidden"
              ...
              >
                ...
                />
                <Button className="min-w-32 text-sm" size="sm" type={'submit'}>
