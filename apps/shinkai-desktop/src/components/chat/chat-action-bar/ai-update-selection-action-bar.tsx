    ...
    <Dialog onOpenChange={setIsDialogOpen} open={isDialogOpen}>
          ...
          >
            ...
            {isRegularChatPage && (
              <div className="flex items-center gap-4 text-left">
                <div className="text-official-gray-750 flex items-center justify-center gap-2 text-xs">
      ...
      <DialogContent className="bg-official-gray-950 border-official-gray-780 size-full max-h-[60vh] w-full max-w-3xl border p-1 py-2">
        ...
        >
          ...
          <CommandEmpty className="text-official-gray-750 py-5 text-center text-sm">
            No results found.
          </CommandEmpty>
              ...
              heading={
                <div className="flex items-center justify-between gap-2 pb-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-official-gray-750 text-sm font-normal">
                  ...
                  >
                    <div className="inline-flex items-center gap-3">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-official-gray-750 line-clamp-1 text-xs">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link
                          className="text-official-official-gray-900 size-8 shrink-0 rounded-lg p-2 hover:text-white"
                ...
                llmProviders?.map((llmProvider) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-official-gray-750 line-clamp-2 text-xs">
