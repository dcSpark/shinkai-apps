      ...
      <>
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              {aiFilesCount > 0 ? (
                <Badge className="bg-official-gray-1000 border-official-gray-900 inline-flex size-4 items-center justify-center rounded-full p-0 text-center text-[10px] text-gray-50">
                  {aiFilesCount}
                </Badge>
              ) : (
