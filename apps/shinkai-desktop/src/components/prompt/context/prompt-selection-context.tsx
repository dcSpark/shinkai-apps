    ...
    >
      <SheetContent side="right">
        ...
        <ScrollArea className="h-[calc(100vh-140px)] pr-4 [&>div>div]:!block">
          <div className="divide-official-official-gray-900 divide-y py-5">
              ...
              promptList?.map((prompt) => (
                ...
                >
                  <div className="absolute right-1 top-1 flex translate-x-[150%] items-center gap-0.5 transition duration-200 group-hover:translate-x-0">
                    <button
                      className="text-official-official-official-gray-900 hover:bg-official-gray-750 rounded-full p-2 transition-colors hover:text-white"
                      onClick={(event) => {
