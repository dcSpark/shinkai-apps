    ...
    <div className="relative flex h-full flex-col">
      ...
      <div className="mt-2 flex justify-between gap-3">
        <div className="relative flex h-10 w-full max-w-[500px] items-center">
          <Input
            className="placeholder-official-official-gray-900 !h-full bg-transparent py-2 pl-10"
            onChange={(e) => {
      ...
      <ScrollArea>
        ...
        >
          ...
          {!searchQuery &&
            ...
            folderList.length === 0 &&
            currentGlobalPath === '/' && (
              <div className="text-official-official-gray-900 mt-4 flex flex-col items-center justify-center gap-4 text-center text-base">
          ...
          {searchQuery &&
            ...
            searchVRItems?.map((item) => {
              return (
                ...
                >
                  <FileTypeIcon />
                  <span className="text-official-official-gray-900 text-sm">
                    {item?.name}
                  </span>
                </button>
              );
      ...
      {isVRSelectionActive && (
        <MotionButton
          animate={{ opacity: 1 }}
          className="border-official-gray-750 bg-official-gray-700 hover:bg-official-gray-850 fixed bottom-12 right-[230px] h-[24px] w-[24px] border p-1 text-gray-50 hover:text-white"
          initial={{ opacity: 0 }}
