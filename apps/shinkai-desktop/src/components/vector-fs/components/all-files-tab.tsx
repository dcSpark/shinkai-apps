    ...
    <div className="relative flex h-full flex-col">
      ...
      <div className="mt-2 flex justify-between gap-3">
        <div className="relative flex h-10 w-full max-w-[500px] items-center">
          <Input
            className="placeholder-official-official-official-gray-900 !h-full bg-transparent py-2 pl-10"
            onChange={(e) => {
      ...
      <ScrollArea>
        ...
        >
          ...
          {!searchQuery &&
            ...
            folderList.length === 0 &&
            currentGlobalPath === '/' && (
              <div className="text-official-official-official-gray-900 mt-4 flex flex-col items-center justify-center gap-4 text-center text-base">
          ...
          {searchQuery &&
            ...
            searchVRItems?.map((item) => {
              return (
                ...
                >
                  <FileTypeIcon />
                  <span className="text-official-official-official-gray-900 text-sm">
                    {item?.name}
                  </span>
                </button>
              );
