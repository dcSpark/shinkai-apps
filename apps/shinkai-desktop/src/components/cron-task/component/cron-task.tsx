...
function CronTask({ mode, initialValues }: CronTaskProps) {
  ...
  return (
    ...
    >
      <p className="text-official-official-gray-900 -mt-8 py-3 pb-6 text-center text-sm">
            ...
            <div className="space-y-4">
              <div className="bg-official-gray-900 space-y-6 rounded-lg px-4 py-4 pb-7">
                  ...
                  <div className="grid grid-cols-[1fr_auto] items-center">
                    ...
                    <DropdownMenu>
                      ...
                      >
                        ...
                        >
                          <DropdownMenuRadioItem
                            className="hover:bg-official-gray-900 aria-checked:bg-official-gray-900 flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-2 text-white transition-colors"
                            value=""
                          >
                ...
                <Collapsible className="space-y-4">
                  <CollapsibleTrigger className="text-official-gray-750 hover:text-official-gray-700 flex items-center gap-1 text-sm [&[data-state=open]>svg]:rotate-90">
                    Advanced
