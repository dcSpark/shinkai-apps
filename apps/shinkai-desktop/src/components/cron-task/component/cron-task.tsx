...
function CronTask({ mode, initialValues }: CronTaskProps) {
  ...
  return (
    ...
    >
      <p className="text-official-official-official-gray-900 -mt-8 py-3 pb-6 text-center text-sm">
                  ...
                  <div className="grid grid-cols-[1fr_auto] items-center">
                    ...
                    <DropdownMenu>
                      ...
                      >
                        ...
                        >
                          <DropdownMenuRadioItem
                            className="hover:bg-official-official-gray-900 aria-checked:bg-official-official-gray-900 flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-2 text-white transition-colors"
                            value=""
                          >
