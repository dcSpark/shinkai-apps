    ...
    <div className="h-full overflow-hidden">
      <div className="bg-background sticky top-0 z-10 mb-2 flex items-center gap-2 p-2">
        <div className="relative flex items-center">
          <Search className="text-official-gray-750 absolute left-3 h-4 w-4" />
          <Input
      ...
      >
        ...
        >
          {virtualizer.getVirtualItems().map((virtualRow) => {
            ...
            return (
              <div
                className="text-official-official-gray-900 border-official-gray-750/10 absolute left-0 top-0 w-full overflow-hidden border-b font-mono text-xs leading-relaxed"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <LogIcon level="INFO" />
                <span className="text-official-gray-750 text-sm font-medium">
                  Log Details
                </span>
              </div>
              <Button
            ...
            <div className="rounded-lg bg-gray-900 p-4">
              <pre className="text-official-gray-750 whitespace-pre-wrap break-words font-mono text-sm leading-relaxed sm:text-base">
                {selectedLog}
              </pre>
            </div>
          </div>
