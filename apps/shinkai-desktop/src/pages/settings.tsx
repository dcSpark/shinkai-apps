  ...
  return (
    <SimpleLayout classname="max-w-xl" title={t('settings.layout.general')}>
      ...
      <div className="flex flex-col space-y-8 pr-2.5">
              ...
              <div className="space-y-1">
                    ...
                    <TextField
                      ...
                      helperMessage={
                        <div className="flex items-center justify-start gap-3">
                          <span className="text-official-official-gray-900 inline-flex items-center gap-1 px-1 py-2.5 hover:text-white">
                            {isIdentityLocalhost ? (
                              <a
                                className={cn(
                                  buttonVariants({
                          ...
                          <a
                            className={cn(
                              ...
                              'text-official-official-gray-900 rounded-lg p-0 text-xs underline hover:text-white',
                            )}
                ...
                {currentShinkaiIdentity !== auth?.shinkai_identity && (
                  <div className="space-y-1.5">
                    <p className="text-official-official-gray-900/80 flex items-center gap-1 text-xs">
        ...
        <div>
          <p className="text-official-official-gray-900 text-right text-xs">
