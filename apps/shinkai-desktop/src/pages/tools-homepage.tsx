        ...
        return (
          <Card
            className={cn(
              ...
              isSelected
                ? 'ring-official-gray-900 border-official-gray-780 bg-official-gray-850 ring-1'
                : '',
            )}
            key={model.id}
            onClick={() => {
              ...
              <div className="flex items-center space-x-2">
                <div
                  className={cn(
                    ...
                    isSelected ? 'text-white' : 'text-official-gray-750',
                  )}
                >
                  <ProviderIcon
                ...
                <CardTitle className="text-official-official-gray-750 text-base font-medium">
                  {model?.name}
                </CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4 p-0">
              <CardDescription className="text-official-gray-750 text-sm">
                {model.description}
              </CardDescription>
              ...
              {model.placeholderId === 'custom-model' && (
                ...
                >
                  ...
                  <SelectContent className="border-official-gray-780 bg-official-gray-900 text-official-official-gray-750">
                    {customModelOptions.map((option) => (
                      <SelectItem
                        className="hover:bg-official-gray-800 focus:bg-official-gray-800 focus:text-official-official-gray-750"
                        key={option.id}
                        value={option.id}
                      >
          ...
          <div className="flex min-h-[300px] w-full flex-col items-center justify-between gap-6 pt-2">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col items-center">
                ...
                <p className="text-official-gray-750 text-center text-sm">
                      ...
                      {error && (
                        <div className="mt-3 flex max-w-full items-start gap-2 rounded-md bg-[#2d0607]/40 px-3 py-2.5 text-xs font-medium text-[#ff9ea1]">
                          ...
                          <div className="flex flex-1 flex-col gap-0.5">
                            ...
                            <div className="text-official-official-gray-900 py-1">
                              {error}
                            </div>
                          </div>
                        </div>
          ...
          <div className="bg-official-gray-1100 relative rounded-lg">
            <div className="relative z-[1] mx-auto flex max-w-[1400px] flex-col items-center gap-8 p-10 text-center">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-official-gray-750 max-w-xl text-base leading-relaxed tracking-tight">
...
const ChatBoxFooterBase = () => {
  return (
    ...
    >
      <div className="text-official-gray-750 flex w-full items-center justify-between gap-2 px-2">
...
function SupportedProtocols() {
  ...
  return (
    <Dialog>
      <DialogTrigger className="text-official-gray-700 hover:text-official-official-gray-900 flex items-center gap-1 text-sm transition-colors">
        <div className="border-official-gray-700 border-b">
              ...
              >
                ...
                <div className="min-w-0 flex-grow">
                  <div className="flex items-center gap-1">
                    ...
                    <ExternalLink className="text-official-gray-850 h-3 w-3 opacity-0 transition-opacity group-hover:opacity-100" />
                  </div>
                  <div className="text-official-gray-750 mt-0.5 flex items-center text-xs">
