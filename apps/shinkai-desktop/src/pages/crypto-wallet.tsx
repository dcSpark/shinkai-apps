...
const CryptoWalletPage = () => {
  ...
  return (
    ...
    >
      {walletExist ? (
        <div className="border-official-gray-900 mt-6 flex w-full items-center justify-between gap-4 rounded-md border px-6 py-3">
        ...
        return (
          <div>
            ...
            <div className="mt-8 space-y-3">
              <Button
                className="hover:bg-official-gray-900 bg-official-gray-850/20 flex h-[auto] w-full items-center justify-start gap-4 rounded-md px-5 py-2.5 text-left"
                onClick={() =>
                  setWalletCreationView(WalletCreateConnectView.Mpc)
                }
                variant="outline"
              ...
              <a
                className={cn(
                  buttonVariants({
                    variant: 'tertiary',
                    className:
                      'hover:bg-official-gray-900 bg-official-gray-850/20 flex h-[auto] w-full items-center justify-start gap-4 rounded-md px-5 py-2.5 text-left',
                  }),
                )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="mt-4 flex flex-row items-center justify-start space-x-3 py-1">
                ...
                <div
                  className={cn(
                    'text-official-official-gray-900 space-y-1 text-sm leading-none',
    ...
    <div>
      ...
      <Form {...form}>
        ...
        >
          ...
          {/*      <Label className="text-official-official-gray-900 pb-2 pl-2 text-xs">*/}
          {/*        Select account type*/}
          {/*      </Label>*/}
          {/*      <FormItem>*/}
          {/*        <FormControl>*/}
          ...
          {/*                />*/}
          {/*                <Label*/}
          {/*                  className="peer-data-[state=checked]:border-brand [&:has([data-state=checked])]:border-brand hover:bg-gray-450 flex cursor-pointer flex-col items-center justify-between rounded-md border-2 border-official-gray-900 bg-official-gray-750 p-4 transition-colors hover:text-white"*/}
          {/*                  htmlFor={value}*/}
          {/*                >*/}
