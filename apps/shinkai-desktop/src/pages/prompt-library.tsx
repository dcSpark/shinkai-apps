      ...
      <div className="grid h-[calc(100dvh-134px)] grid-cols-[250px_1fr]">
        <ScrollArea className="h-full border-r border-gray-400 pr-4 [&>div>div]:!block">
          <div className="relative mb-4 flex h-10 w-full items-center">
            <Input
              className="placeholder-official-official-gray-600 !h-full border-none bg-gray-400 py-2 pl-10"
              onChange={(e) => {
          ...
          <div className="flex flex-col gap-1">
            {(isPending || !isSearchQuerySynced || isSearchPromptListPending) &&
              Array.from({ length: 8 }).map((_, idx) => (
                <div
                  className={cn(
                    'text-official-official-gray-600 mb-2 flex h-10 w-full items-center gap-5 rounded-md px-2 py-2.5 text-left text-sm hover:bg-gray-300 hover:text-white',
            ...
            {!searchQuery &&
              ...
              promptList?.map((prompt) => (
                <button
                  className={cn(
                    'text-official-official-gray-600 flex items-center gap-5 rounded-md px-2 py-2.5 pr-6 text-left text-sm hover:bg-gray-300 hover:text-white',
            ...
            {searchQuery &&
              ...
              searchPromptList?.map((prompt) => (
                <button
                  className={cn(
                    'text-official-official-gray-600 flex items-center gap-5 rounded-md px-2 py-2.5 pr-6 text-left text-sm hover:bg-gray-300',
                    selectedPrompt?.name === prompt.name &&
                      'bg-gray-300 text-white',
                  )}
                  key={prompt.name}
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="text-official-official-gray-600 border-official-gray-600 flex h-7 min-w-[100px] items-center justify-center gap-1 rounded-lg border bg-transparent text-xs font-medium transition-colors hover:bg-gray-300 hover:text-white"
                onClick={() => {
      ...
      <AnimatePresence>
        {!isLoadingMessage && chatInboxId && (
          <motion.div
            ...
            initial={{ opacity: 0 }}
          >
            <p className="text-official-official-gray-600 bg-official-gray-600 border-b border-gray-300 px-2.5 py-2 text-xs">
              Output
            </p>
            <div className="p-4">
              <MarkdownText
