  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      >
        ...
        <ToggleGroupItem className="h-8 min-w-[70px] rounded-full border-none text-sm" value="free">
          Free
        </ToggleGroupItem>
        <ToggleGroupItem
          className="h-8 min-w-[70px] rounded-full border-none text-sm"
            ...
            {data?.pages.map((page, idx) => (
              <Fragment key={idx}>
                {page.values.map((sharedFolder) => {
                  ...
                  return (
                    <PublicSharedFolder
                      folderDescription={sharedFolder?.folderDescription ?? 'no description found'}
  ...
  return (
    <DrawerContent>
      ...
      <DrawerHeader>
        ...
        <DrawerDescription>List of folders and files shared with you</DrawerDescription>
      </DrawerHeader>
